...
const Header = ({ children, headerBig }: Props): JSX.Element => {
  ...
  return (
    <>
      <div
        className="p-0 text-center relative overflow-hidden bg-no-repeat  bg-center bg-cover  "
        style={{
          backgroundImage:
        ...
        >
          <div className="flex justify-center items-center h-full">
            <div className="text-white px-5 lg:px-0 md:px-0 text-left">
              <h4 className="font-semibold text-base sm:text-xl sm:w-[24rem] md:text-2xl md:w-[30rem] lg:text-2xl w-70 lg:w-[30rem] ">
                {" "}
                {phrase}{" "}
              </h4>
              {children}
